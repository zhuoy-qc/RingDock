...
if __name__ == "__main__":
    input_pdb = "3FX4_protein.pdb"  # Replace with your input file path
    clean_pdb(input_pdb) 
"""
...
def create_complex_pdb(subdir_path):
    ...
    try:
        ...
        if protein_files:
            ...
            try:
                clean_pdb(str(protein_file), str(purified_file))
                protein_file = purified_file
                print(f"Purified protein file created: {protein_file.name}")
