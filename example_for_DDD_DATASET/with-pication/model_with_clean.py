...
def cleanup_generated_files_recursive(base_directory):
    """Remove generated files in specified formats from base directory and all its subdirectories"""
    patterns_to_remove = [
        'plipfixed.*.pdb',
    ...
    for pattern in patterns_to_remove:
        ...
        pattern_path = os.path.join(base_directory, '**', pattern)
    ...
    if files_removed > 0:
        logger.info(f"✅ Cleaned up {files_removed} generated files from directory tree")
    else:
...
if __name__ == "__main__":
    ...
    # Clean up generated files in the root directory and all subdirectories
