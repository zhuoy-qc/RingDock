...
if __name__ == "__main__":
    ...
    # Step 1: Generate complexes for each subdirectory
    print("\n1️⃣  STEP 1: GENERATING PROTEIN-LIGAND COMPLEXES IN ALL DIRECTORIES")
    print("-" * 50)
    all_complex_dirs = []
    ...
    print("\n2️⃣  STEP 2: PI-CATION RANGE FILTERING AND MODEL INPUT PREPARATION")
    print("-" * 50)
