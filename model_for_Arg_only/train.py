...
plt.subplot(2, 1, 1)
plt.plot(range(len(monitor.train_losses)), monitor.train_losses, label='Training MSE', linewidth=2)
plt.plot(range(len(monitor.val_losses)), monitor.val_losses, label='Validation MSE', linewidth=2)
plt.axvline(x=monitor.best_iter, color='r', linestyle='--', alpha=0.7, label='Best Model')
...
plt.subplot(2, 1, 2)
plt.plot(range(len(monitor.train_r2)), monitor.train_r2, label='Training R²', linewidth=2)
plt.plot(range(len(monitor.val_r2)), monitor.val_r2, label='Validation R²', linewidth=2)
plt.axvline(x=monitor.best_iter, color='r', linestyle='--', alpha=0.7, label='Best Model')
plt.xlabel('Iteration')
plt.ylabel('R² Score')
